...
(function () {
    ...
    // 1. Identifiant unique du visiteur (persiste sur le long terme)
    function getVisitorId() {
        let vid = localStorage.getItem('actere_visitor_id');
        if (!vid) {
    ...
    function getSessionId() {
        let sid = sessionStorage.getItem('actere_session_id');
        if (!sid) {
    ...
    function trackPageView() {
        const payload = {
            ...
            os: getOSName(),
            screen_resolution: ${window.screen.width}x
        };
